# Dashboard Structure (For New Contributors)
...
### Tests
- Tests can be found in the top level `/test/` directory. The test directory is structured to mirror the `/src/` directory.
