...
outside of the cluster, given that it can connect to the control plane. The backend is an HTTP server
that proxies data requests to appropriate remote backends (e.g., Kubernetes API) or implements
