...
import (
	v1alpha1 "github.com/kubernetes-sigs/application/pkg/apis/app/v1alpha1"
...
var applicationsResource = schema.GroupVersionResource{Group: "app.k8s.io", Version: "v1alpha1", Resource: "applications"}

var applicationsKind = schema.GroupVersionKind{Group: "app.k8s.io", Version: "v1alpha1", Kind: "Application"}
