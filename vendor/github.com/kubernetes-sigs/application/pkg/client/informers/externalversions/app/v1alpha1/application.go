...
import (
	app_v1alpha1 "github.com/kubernetes-sigs/application/pkg/apis/app/v1alpha1"
	...
	v1alpha1 "github.com/kubernetes-sigs/application/pkg/client/listers/app/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppV1alpha1().Applications(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppV1alpha1().Applications(namespace).Watch(options)
			},
		},
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&app_v1alpha1.Application{}, f.defaultInformer)
}
