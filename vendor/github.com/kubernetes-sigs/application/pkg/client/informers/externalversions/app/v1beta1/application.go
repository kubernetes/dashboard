...
import (
	...
	app_v1beta1 "github.com/kubernetes-sigs/application/pkg/apis/app/v1beta1"
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&app_v1beta1.Application{}, f.defaultInformer)
}
