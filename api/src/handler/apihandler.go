...
import (
	...
	"github.com/kubernetes/dashboard/api/src/resource/networkpolicy"

	"github.com/kubernetes/dashboard/api/src/handler/parser"
	"github.com/kubernetes/dashboard/api/src/resource/customresourcedefinition/types"

	"github.com/kubernetes/dashboard/api/src/plugin"
	...
	"github.com/kubernetes/dashboard/api/src/auth"
	...
	"github.com/kubernetes/dashboard/api/src/integration"
	"github.com/kubernetes/dashboard/api/src/resource/clusterrole"
	"github.com/kubernetes/dashboard/api/src/resource/clusterrolebinding"
	"github.com/kubernetes/dashboard/api/src/resource/common"
	"github.com/kubernetes/dashboard/api/src/resource/configmap"
	"github.com/kubernetes/dashboard/api/src/resource/container"
	"github.com/kubernetes/dashboard/api/src/resource/controller"
	"github.com/kubernetes/dashboard/api/src/resource/cronjob"
	"github.com/kubernetes/dashboard/api/src/resource/customresourcedefinition"
	"github.com/kubernetes/dashboard/api/src/resource/daemonset"
	"github.com/kubernetes/dashboard/api/src/resource/dataselect"
	"github.com/kubernetes/dashboard/api/src/resource/deployment"
	"github.com/kubernetes/dashboard/api/src/resource/event"
	"github.com/kubernetes/dashboard/api/src/resource/horizontalpodautoscaler"
	"github.com/kubernetes/dashboard/api/src/resource/ingress"
	"github.com/kubernetes/dashboard/api/src/resource/job"
	"github.com/kubernetes/dashboard/api/src/resource/logs"
	ns "github.com/kubernetes/dashboard/api/src/resource/namespace"
	"github.com/kubernetes/dashboard/api/src/resource/node"
	"github.com/kubernetes/dashboard/api/src/resource/persistentvolume"
	"github.com/kubernetes/dashboard/api/src/resource/persistentvolumeclaim"
	"github.com/kubernetes/dashboard/api/src/resource/pod"
	"github.com/kubernetes/dashboard/api/src/resource/replicaset"
	"github.com/kubernetes/dashboard/api/src/resource/replicationcontroller"
	"github.com/kubernetes/dashboard/api/src/resource/role"
	"github.com/kubernetes/dashboard/api/src/resource/rolebinding"
	"github.com/kubernetes/dashboard/api/src/resource/secret"
	resourceService "github.com/kubernetes/dashboard/api/src/resource/service"
	"github.com/kubernetes/dashboard/api/src/resource/serviceaccount"
	"github.com/kubernetes/dashboard/api/src/resource/statefulset"
	"github.com/kubernetes/dashboard/api/src/resource/storageclass"
	"github.com/kubernetes/dashboard/api/src/scaling"
	"github.com/kubernetes/dashboard/api/src/settings"
	settingsApi "github.com/kubernetes/dashboard/api/src/settings/api"
	"github.com/kubernetes/dashboard/api/src/systembanner"
