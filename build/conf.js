...
export default {
  ...
  paths: {
    ...
    i18n: path.join(basePath, 'src/app/i18n'),
    ...
    soyTemplates: path.join(basePath, 'src/app/i18n/soy-templates'),
    soyTranslations: path.join(basePath, 'src/app/i18n/soy-translations'),
