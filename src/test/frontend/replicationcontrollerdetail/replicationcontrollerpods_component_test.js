...
describe('Replication Controller Pods controller', () => {
  /**
   * Replication Controller Events controller.
   * @type
   *  {!replicationcontrollerdetail/replicationcontrollerpods_component.ReplicationControllerPodsController}
   */
  let ctrl;
  ...
  beforeEach(() => {
    ...
    angular.mock.inject(($componentController) => {
      ctrl = $componentController('kdReplicationControllerPods', {
        $stateParams:
