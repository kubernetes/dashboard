...
import {resolveNetworkPolicyList} from 'networkpolicy/list/stateconfig';
import networkPolicyModule from 'networkpolicy/module';

describe('StateConfig for network policy controller list', () => {
  ...
  it('should resolve network policy list', angular.mock.inject(($q) => {
    ...
    let actual = resolveNetworkPolicyList(resource, {namespace: 'foo'}, kdDataSelectService);
