...
describe('Limit Range card', () => {
  /** @type {!limitrangelist/limitrangecard_component.LimitRangeCardController} */
  let ctrl;
  ...
  beforeEach(() => {
    ...
    angular.mock.inject(($componentController, $rootScope) => {
      ctrl = $componentController('kdLimitRangeCard', {$scope: $rootScope});
    });
  });
  ...
  it('should get details href', () => {
    ...
    expect(ctrl.getLimitRangeDetailHref()).toBe('#/limitrange/foo/bar');
  });
