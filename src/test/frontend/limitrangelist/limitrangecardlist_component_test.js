...
describe('Limit Range card list', () => {
  /** @type {!limitrangelist/limitrangecard_component.LimitRangeCardListController} */
  let ctrl;
  /**
  ...
  beforeEach(() => {
    ...
    angular.mock.inject(($componentController, $rootScope, kdNamespaceService) => {
      ...
      /** @type {!LimitRangeCardListController} */
      ctrl = $componentController(
          'kdLimitRangeCardList', {$scope: $rootScope, kdNamespaceService_: data}, {});
    });
  });
