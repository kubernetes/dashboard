...
export class LabelKeyPrefixPatternType extends Type {
  ...
  isValid(value) {
    ...
    /** @type {number} */
    let slashPosition = isPrefixed ? value.lastIndexOf("/") : -1;
    /** @type {!RegExp} */
    let labelKeyPrefixPattern = /^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$/;
    /** @type {string} */
    let labelKeyPrefix = isPrefixed ? value.substring(0, slashPosition) : "valid-pattern";

    return (labelKeyPrefixPattern.test(labelKeyPrefix));
  }
}
