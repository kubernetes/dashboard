...
export class ServiceListComponent extends
    ResourceListWithStatuses<ServiceList, Service> {
  ...
  constructor(
    ...
    this.registerBinding(
        this.icon.checkCircle, 'kd-success', this.isInSuccessState.bind(this));
    this.registerBinding(
        this.icon.timelapse, 'kd-muted', this.isInPendingState.bind(this));
  ...
  /**
   * Service is in success state if cluster IP is defined and service type is
   * LoadBalancer and external endpoints exist.
   */
