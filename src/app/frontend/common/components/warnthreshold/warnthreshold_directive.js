...
/**
 * Description:
 *    <input type="number" kd-warn-threshold>` - can be used to warn user that some number may
 *    be too big for given input field but not block the actual form submit.
 *
 * Params:
 *    - warnThreshold {number} Max number that is allowed before input field will be marked with
 *      a warning.
 *
 * Usage:
 *    <md-input-container>
 *      <input type="number" name="maxInput" kd-warn-threshold="100">
 *      <span class="kd-warn-threshold" ng-show="maxInput.kdWarnThreshold">Warning message</span>
 *    </md-input-container>
 *
