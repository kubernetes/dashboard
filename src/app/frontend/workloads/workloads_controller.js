...
export class WorkloadsController {
   ...
   * @param {!./../podlist/podlist_factory.PodListFactory} kdPodListFactory
   * @ngInject
   */
  constructor(workloads, kdPodListFactory) {
    /** @export {!backendApi.Workloads} */
    this.workloads = workloads;

    /** @export {!./../podlist/podlist_factory.PodListFactory} */
    this.podListFactory = kdPodListFactory;
