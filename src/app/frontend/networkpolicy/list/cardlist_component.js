 ...
 * @final
 */
class NetworkPolicyCardListController {
  /**
  ...
  constructor(kdNamespaceService) {
    ...
    /** @export {!backendApi.NetworkPolicyList} - Initialized from binding. */
    this.networkPolicyList;
    /** @export {!angular.Resource} - Initialized from binding. */
    this.networkPolicyListResource;
  }
 ...
 */
export const networkPolicyCardListComponent = {
  transclude: {
  ...
  templateUrl: 'networkpolicy/list/cardlist.html',
  controller: NetworkPolicyCardListController,
};
