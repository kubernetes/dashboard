...
export class ObjectCardController {
  ...
  constructor($interpolate) {
     ...
     * @export {!backendApi.CustomResourceDefinitionObject}
     */
    this.object;
  }
  ...
  getStartedAtTooltip(startDate) {
     ...
     */
    let MSG_CRD_LIST_STARTED_AT_TOOLTIP =
        goog.getMsg('Started at {$startDate} UTC', {'startDate': filter({'date': startDate})});
    return MSG_CRD_LIST_STARTED_AT_TOOLTIP;
  }
}

/**
 * Definition object for the component that displays custom resource definition objects card.
...
export const objectCardComponent = {
  ...
  templateUrl: 'customresourcedefinition/detail/objectcard.html',
};
