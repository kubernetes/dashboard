...
class ObjectListController {
  /** @ngInject */
  constructor() {
    /** @export {!backendApi.CustomResourceDefinitionObjectList} - Initialized from binding. */
    this.objectList;
   ...
   */
  getSelectId() {
    const selectId = 'customresourcedefinitionobjects';
...
/**
 * Definition object for the component that displays custom resource definition objects list card.
 *
...
export const objectListComponent = {
  ...
  templateUrl: 'customresourcedefinition/detail/objectlist.html',
  bindings: {
