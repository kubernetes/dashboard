...
export default class NodeInfoController {
   ...
   * @param {function(number): string} kdMemoryFilter
   * @ngInject
   */
  constructor($interpolate, kdMemoryFilter) {
    /**
    ...
    /** @private */
    this.memoryFilter_ = kdMemoryFilter;

    /** @export */
    this.i18n = i18n(this.node, this.memoryFilter_);
  }
...
/**
 * @param {!backendApi.NodeDetail} node
 * @return {!Object} a dictionary of translatable messages
 */
function i18n(node, memoryFilter) {
  return {
