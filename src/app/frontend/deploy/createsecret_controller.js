...
const i18n = {
  /** @export {string} @desc Create image pull secret dialog title. The message appears at the top
     of the dialog box. */
  MSG_IMAGE_PULL_SECRET_CREATE_DIALOG_TITLE: goog.getMsg('Create a new image pull secret'),

  /** @export {string} @desc Create image pull secret dialog subtitle. Appears right below the
     title. */
  MSG_IMAGE_PULL_SECRET_CREATE_DIALOG_SUBTITLE:
      goog.getMsg('The new secret will be added to the cluster'),

  /** @export {string} @desc Label 'Secret name', which appears as a placeholder in an empty input
     field in the image pull secret creation dialog. */
  MSG_IMAGE_PULL_SECRET_NAME_LABEL: goog.getMsg('Secret name'),

  /** @export {string} @desc The text appears when the image pull secret name does not match the
     expected pattern. */
  ...
  /** @export {string} @desc The text appears when the image pull secret name exceeds the maximal
     length. */
  MSG_IMAGE_PULL_SECRET_NAME_LENGTH_WARNING:
      goog.getMsg('Name must be up to {$maxLength} characters long.', {'maxLength': 253}),

  /** @export @type string  @desc Warning which tells the user that the image pull secret name is
     required. */
  MSG_IMAGE_PULL_SECRET_NAME_REQUIRED_WARNING: goog.getMsg('Name is required.'),

  /** @export {string} @desc  User help text for the create image pull secret dialog. Directly after
     this text a specific namespace is specified. */
  ...
  /** @export {string} @desc Label 'Image pull secret data', which appears as a placeholder in an
     empty input field in the image pull secret creation dialog. */
  MSG_IMAGE_PULL_SECRET_DATA_LABEL: goog.getMsg('Image pull secret data'),

  /** @export {string} @desc Warning which tells the user that the image pull secret data is
     required. */
  ...
  /** @export {string} @desc The text is put on the 'Create' button in the image pull secret
     creation dialog. */
  MSG_IMAGE_PULL_SECRET_CREATE_ACTION: goog.getMsg('Create'),

  /** @export {string} @desc The text is put on the 'Cancel' button in the image pull secret
     creation dialog. */
  MSG_IMAGE_PULL_SECRET_CANCEL_ACTION: goog.getMsg('Cancel'),

  /** @export {string} @desc The text is used as a 'Learn more' link text in the image pull secret
     creation dialog */
