...
export default class NodeCardController {
   ...
   */
  getNodeDetailHref() {
    // TODO(maciaszczykm): 2 state params cause 2 slashes in link. I.E. #/node//127.0.0.1.
    return this.state_.href(stateName, new StateParams(null, this.node.objectMeta.name));
  }
...
const i18n = {
  /** @export {string} @desc Label 'Node' which appears at the top of the delete dialog, opened
   *  from a node list page. */
  MSG_NODE_LIST_NODE_LABEL: goog.getMsg('Node'),
};
