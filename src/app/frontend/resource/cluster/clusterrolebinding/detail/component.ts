...
export class ClusterRoleBindingDetailComponent implements OnInit, OnDestroy {
  private clusterRoleBindingSubscription_: Subscription;
  ...
  ngOnInit(): void {
    ...
    this.clusterRoleBindingSubscription_ = this.clusterRoleBinding_
      .get(this.endpoint_.detail(), resourceName)
      .subscribe((d: ClusterRoleBindingDetail) => {
        this.clusterRoleBinding = d;
        this.notifications_.pushErrors(d.errors);
        this.actionbar_.onInit.emit(
          new ResourceMeta('Cluster Role Binding', d.objectMeta, d.typeMeta),
        );
  ...
  ngOnDestroy(): void {
    this.clusterRoleBindingSubscription_.unsubscribe();
