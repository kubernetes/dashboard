...
export class StatefulSetDetailComponent implements OnInit, OnDestroy {
  ...
  private readonly endpoint_ =
      EndpointManager.resource(Resource.statefulSet, true);
  ...
  constructor(
      private readonly statefulSet_:
          NamespacedResourceService<StatefulSetDetail>,
  ...
  ngOnInit(): void {
    ...
    this.podListEndpoint =
        this.endpoint_.child(resourceName, Resource.pod, resourceNamespace);
