...
class ApplicationGenericResourceCardListController {
  ...
  $onInit() {
    this.applicationGenericResourceListResource =
        this.$resource_(`api/v1/application/${this.$stateParams_.objectNamespace}/${
            this.applicationName}/${this.groupName}/${this.kindName}`);
  ...
  getSelectId() {
    ...
    if (this.applicationGenericResourceList !== undefined &&
