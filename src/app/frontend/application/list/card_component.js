...
class ApplicationCardController {
  ...
  getApplicationDetailHref() {
    return this.state_.href(
        stateName,
        new StateParams(this.application.objectMeta.namespace, this.application.objectMeta.name));
  }
}
...
export const applicationCardComponent = {
  ...
  templateUrl: 'application/list/card.html',
};
