...
import {StatefulSetListController} from './statefulsetlist_controller';
import {stateName, stateUrl} from './statefulsetlist_state';
  ...
  $stateProvider.state(stateName, {
    ...
    views: {
      '': {
        ...
        controllerAs: '$ctrl',
        templateUrl: 'statefulsetlist/statefulsetlist.html',
      },
    },
  });
}
