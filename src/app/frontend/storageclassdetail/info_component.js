 ...
 * @final
 */
export default class StorageClassInfoController {
  /**
   * Constructs storage class controller info object.
   * @ngInject
   */
  constructor() {
    /**
     * Storage Class details. Initialized from the scope.
...
export const storageClassInfoComponent = {
  controller: StorageClassInfoController,
