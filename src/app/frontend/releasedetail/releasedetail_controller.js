...
const i18n = {
  ...
  MSG_RELEASE_DETAIL_ZEROSTATE_TITLE: goog.getMsg('There is nothing to display here'),
  /** @export {string} @desc Text for relase cards zero-state in release details page. */
  MSG_RELEASE_DETAIL_ZEROSTATE_TEXT: goog.getMsg('There are currently no details on this Release'),
};
