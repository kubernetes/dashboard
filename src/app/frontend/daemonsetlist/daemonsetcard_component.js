...
export class DaemonSetCardController {
  ...
  getDaemonSetDetailHref() {
    return this.state_.href(
        stateName, new StateParams(this.daemonSet.objectMeta.namespace, this.daemonSet.objectMeta.name));
  }
  ...
  getCreatedAtTooltip() {
    ...
    let MSG_DAEMON_SET_LIST_CREATED_AT_TOOLTIP =
        goog.getMsg('Created at {$creationDate}', {'creationDate': filter({'date': this.daemonSet.objectMeta.creationTimestamp})});
