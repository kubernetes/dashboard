...
import {activeJobsResource, eventsResource} from './detail/stateconfig';
...
/**
 * Angular module for the Cron Job resource.
 */
export default angular
    .module(
        'kubernetesDashboard.cronjob',
        [
          'ngMaterial',
          'ngResource',
          'ui.router',
    ...
    .factory('kdEventsResource', eventsResource)
