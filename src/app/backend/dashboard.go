...
var (
	...
	argAuthenticationMode = pflag.StringSlice("authentication-mode", []string{string(authApi.Token)}, "Enables authentication options that will be reflected on login screen. Supported values: token, basic. Default: token."+
