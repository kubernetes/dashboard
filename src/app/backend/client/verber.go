...
func (verber *resourceVerber) getRESTClientByType(clientType api.ClientType) RESTClient {
	...
	case api.ClientTypeSigAppsClient:
		return verber.sigAppsClient
	default:
...
func NewResourceVerber(client, extensionsClient, appsClient,
	batchClient, betaBatchClient, autoscalingClient, sigAppsClient, storageClient RESTClient) clientapi.ResourceVerber {
	return &resourceVerber{client, extensionsClient, appsClient,
		batchClient, betaBatchClient, autoscalingClient, storageClient, sigAppsClient}
}
