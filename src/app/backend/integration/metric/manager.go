...
import (
	...
	"github.com/kubernetes/dashboard/v2/src/app/backend/integration/metric/heapster"
	"github.com/kubernetes/dashboard/v2/src/app/backend/integration/metric/sidecar"
