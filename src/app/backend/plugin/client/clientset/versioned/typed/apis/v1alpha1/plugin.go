...
func (c *plugins) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
...
func (c *plugins) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
