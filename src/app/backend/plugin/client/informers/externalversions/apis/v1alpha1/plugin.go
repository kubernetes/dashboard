...
import (
	...
	apisv1alpha1 "github.com/kubernetes/dashboard/v2/src/app/backend/plugin/apis/v1alpha1"
	...
	v1alpha1 "github.com/kubernetes/dashboard/v2/src/app/backend/plugin/client/listers/apis/v1alpha1"
