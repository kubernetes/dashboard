...
func (cell ReplicationControllerCell) GetProperty(name dataselect.PropertyName) dataselect.ComparableValue {
	switch name {
...
func (cell ReplicationControllerCell) GetResourceSelector() *metricapi.ResourceSelector {
