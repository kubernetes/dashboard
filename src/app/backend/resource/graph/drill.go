...
// Format of the data used in this module. This is also the format of data that is being sent by backend API.
type Data struct {
...
// Struct used for parallel data extraction. Contains len 1 channels for Data and Error
...
// Selection containing resources natively supported by heapster
...
// Selection containing resources not natively supported by heapster
...
// Format of the JSON provided by heapster.
...
// simple general dependency resolution algorithm
...
//
// Determines resource download order from heapster.
...
// Converts this drill to its heapster path
...
// Lists all the metrics available for this drill
...
// Lists all the resource names available for this drill.
...
// Downloads one metric for this drill from heapster and returns it as a DataPromise (returns instantly).
...
// Downloads the metrics provided in parallel and returns DataPromise list.
...
// Converts selection to drill. Useful if you want to determine resource download order (because Drill
...
// Converts all the data points from format used by heapster to our format.
...
// Converts raw data point supplied by heapster to our internal format
