...
// Aggregating modes which should be used for data aggregation. Eg. [sum, min, max]
...
// implement sort.Interface for []int64. This allows to use built in sort with int64
...
// For all metrics it aggregates all the data from dataList using AggregatingFunction with name aggregateName.
...
// For all Data entries of given metric it generates a cumulative map X -> [List of all Ys at this X].
