...
// EventListChannel is a list and error channels to event.
...
// PodListChannel is a list and error channels to pod.
...
// ReplicationControllerListChannel is a list and error channels to replication.
...
// DaemonSetListChannel is a list and error channels to damonSet.
...
// JobListChannel is a list and error channels to job.
...
// StatefulSetListChannel is a list and error channels to statefulset.
