...
func (cell CronJobCell) GetProperty(name dataselect.PropertyName) dataselect.ComparableValue {
	switch name {
...
func (cell CronJobCell) GetResourceSelector() *metricapi.ResourceSelector {
