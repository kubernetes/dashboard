...
func CreateHTTPAPIHandler(client *clientK8s.Clientset, heapsterClient client.HeapsterClient,
	...
	apiV1Ws.Route(
		apiV1Ws.GET("/appdeployment/protocols").
			To(apiHandler.injectApiClient(apiHandler.handleGetAvailableProcotols)).
...
func (apiHandler *APIHandler) handleGetAvailableProcotols(apiClient *clientK8s.Clientset, request *restful.Request, response *restful.Response) {
