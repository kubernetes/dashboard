...
import (
	...
	apisv1alpha1 "k8s.io/dashboard/api/pkg/plugin/apis/v1alpha1"
	versioned "k8s.io/dashboard/api/pkg/plugin/client/clientset/versioned"
	internalinterfaces "k8s.io/dashboard/api/pkg/plugin/client/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/dashboard/api/pkg/plugin/client/listers/apis/v1alpha1"
